 ...
 * @date 2017/6/29
 */
public class ChooseItemProcessor implements Processor<ProcessorContext> {
    private static final Logger logger = LoggerFactory.getLogger(ChooseItemProcessor.class);
    ...
    public void process(ProcessorContext data) {
        ...
        if (students != null && !students.isEmpty())
            logger.info(students.stream().map(Student::getName).collect(Collectors.joining()) + "开始做选择题...");
    }
}
